  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Meridian is a next-generation employment services platform — from referral to sustainment — for advisors, participants, and programme performance.",
      },
      { name: "theme-color", content: "#1a5c4a" },
    ],
    links: [
